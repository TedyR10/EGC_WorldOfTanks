...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix,glm::vec3(0.25f, 0.25f, 0.25f));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint light_position = glGetUniformLocation(shader->GetProgramID(), "light_position");
    ...
    GLint eye_position = glGetUniformLocation(shader->GetProgramID(), "eye_position");
    ...
    GLint shine_position = glGetUniformLocation(shader->GetProgramID(), "material_shininess");
    glUniform1i(shine_position, materialShininess);

    GLint kd_position = glGetUniformLocation(shader->GetProgramID(), "material_kd");
	glUniform1f(kd_position, materialKd);

    GLint ks_position = glGetUniformLocation(shader->GetProgramID(), "material_ks");
	glUniform1f(ks_position, materialKs);

    GLint color_position = glGetUniformLocation(shader->GetProgramID(), "object_color");
