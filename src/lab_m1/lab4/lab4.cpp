...
void Lab4::RenderScene() {
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(2.5f, 0.5f, -1.5f);
    modelMatrix *= transform3D::Translate(-2.5f, 0.0f, 0.0f) * transform3D::RotateOY(angularStep) * transform3D::Translate(2.5f, 0.0f, 0.0f);
...
void Lab4::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_I) {
        miniViewportArea.y = resolution.y - 150;
    }
    ...
    if (key == GLFW_KEY_L) {
        miniViewportArea.x = resolution.x - 300;
    }
