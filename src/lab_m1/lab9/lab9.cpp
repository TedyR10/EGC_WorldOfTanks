...
void Lab9::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, -GetSceneCamera()->m_transform->GetLocalOXVector().x * 2, glm::vec3(0, 1, 0));
        cout << GetSceneCamera()->m_transform->GetLocalOXVector().x << endl;
